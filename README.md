...
auto-purchase is a `<utility/tool/feature>` that allows `<insert_target_audience>` to do `<action/task_it_does>`.

## Inspiration

auto-purchase was inspired by `<reason/idea>`.
...
auto-purchase was built using `<tech/library>`

## Challenges faced

While building auto-purchase the main challenges were `<issue/difficulty>`

## What I learned

While building auto-purchase I `<learned/accomplished>` about `<learning/accomplishment>`
